(function(){
  ...
  const serviceFeatures={
    ...
    "gemini-pro":[
      "الوصول إلى نماذج Gemini المتقدمة بحدود استخدام أعلى",
      "Gemini Live للمحادثة الصوتية والتفاعل المباشر",
      "Deep Research للبحث المتعمق وتجميع المعلومات",
      "رفع وتحليل الملفات والمستندات والصور",
      "سياق طويل للتعامل مع ملفات ومحتوى كبير",
      "إنشاء وتحرير الصور بالذكاء الاصطناعي",
      "إنشاء فيديوهات بالذكاء الاصطناعي عبر أدوات Google المؤهلة",
      "1,000 AI Credit شهريًا لاستخدام Google Flow حسب الخطة",
      "استخدام Gemini داخل Gmail لكتابة وتلخيص الرسائل",
      "استخدام Gemini داخل Google Docs للكتابة والتلخيص والتحرير",
      "مساعدة ذكية داخل Google Drive للبحث في الملفات وتلخيصها",
      "استخدام Gemini داخل Sheets لتحليل وتنظيم البيانات",
      "استخدام Gemini داخل Slides للمساعدة في إنشاء العروض",
      "تكامل مع Google Calendar وTasks وKeep عبر Gemini Apps",
      "Gemini Notebook بحدود وإمكانات أعلى حسب الخطة",
      "مساعدة في البرمجة وإنشاء الأكواد وشرحها",
      "تلخيص المحتوى الطويل والمقارنة بين مصادر متعددة",
      "الوصول إلى مزايا Google AI الجديدة المؤهلة عند توفرها للحساب والمنطقة"
    ],
  ...
  const categoryFeatureBoosters={
    "AI Tools":[
      "توفير وقت كبير في تنفيذ المهام اليومية",
      "المساعدة في توليد الأفكار وصياغة المحتوى",
      "تلخيص النصوص والمعلومات الطويلة بسرعة",
      "تحسين وإعادة صياغة المحتوى",
      "المساعدة في البحث وتجميع المعلومات",
      "دعم مهام الدراسة والعمل والمشاريع",
      "المساعدة في تحليل النصوص والبيانات",
      "رفع الإنتاجية في المهام المتكررة"
    ],
    "التصميم":[
      "تسريع إنتاج المحتوى البصري",
      "الوصول إلى أدوات احترافية أكثر من الخطة المجانية",
      "تسهيل إنشاء محتوى للسوشيال ميديا",
      "دعم التصميم والمونتاج للمشاريع المختلفة",
      "توفير قوالب وموارد جاهزة للاستخدام",
      "تحسين جودة العمل البصري",
      "تسريع التعديلات والتجارب الإبداعية",
      "مناسب للمصممين وصناع المحتوى"
    ],
    "التعليم":[
      "مناسب للتعلم الذاتي وتطوير المهارات",
      "الوصول إلى أدوات تعليمية تفاعلية",
      "تنظيم التعلم والمراجعة بشكل أسهل",
      "توفير محتوى وتمارين تساعد على التطبيق",
      "مفيد للطلاب والمعلمين",
      "تسهيل متابعة التقدم والتعلم المستمر",
      "دعم الدراسة والمراجعة اليومية",
      "تحسين تجربة التعلم مقارنة بالاستخدام الأساسي"
    ],
    "الإنتاجية":[
      "تسريع إنجاز المهام اليومية",
      "تنظيم العمل والمشاريع بشكل أفضل",
      "تقليل الوقت الضائع في المهام المتكررة",
      "تحسين التعاون ومشاركة المعلومات",
      "مناسب للاستخدام الشخصي والمهني",
      "تجميع الأدوات المهمة في سير عمل واحد",
      "رفع كفاءة إدارة المحتوى والملفات",
      "تسهيل المتابعة والتنظيم"
    ],
    "VPN والحماية":[
      "تشفير الاتصال أثناء استخدام الإنترنت",
      "حماية أفضل عند استخدام شبكات Wi-Fi العامة",
      "تقليل كشف عنوان IP الحقيقي",
      "تغيير الموقع الافتراضي عند الاتصال بالخوادم",
      "تعزيز الخصوصية أثناء التصفح",
      "اتصال أكثر أمانًا أثناء السفر",
      "استخدام أسهل للخدمات أثناء التنقل",
      "طبقة حماية إضافية للاتصال اليومي"
    ],
    "الترفيه":[
      "تجربة استخدام أفضل من الخطة المجانية",
      "مزايا إضافية للمشاهدة أو الاستماع",
      "تقليل القيود الموجودة في الاستخدام المجاني",
      "سهولة أكبر في الوصول للمحتوى",
      "مناسب للاستخدام اليومي على الهاتف والكمبيوتر",
      "تجربة أكثر سلاسة للمحتوى المفضل",
      "مزايا Premium داخل الخدمة",
      "تحسين تجربة الترفيه والاستخدام الشخصي"
    ]
  };
